    ...
    const rowElements = guesses.map((guess, index) => {
        return (
            <div className="row" key={index}>
                <div className="tile">{guess[0].letter || ""}</div>
                <div className="tile">{guess[1].letter || ""}</div>
                <div className="tile">{guess[2].letter || ""}</div>
                <div className="tile">{guess[3].letter || ""}</div>
                <div className="tile">{guess[4].letter || ""}</div>
            </div>
        )
    })
